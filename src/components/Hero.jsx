      ...
      <div className="container">
        <div className="hero-inner">
          <div className="hero-text">
            ...
            <p className="hero-desc animate d2">Boost volume up to 1000%, normalize loud & quiet audio automatically, and mix every tab independently - like a pro audio console for your browser.</p>
            ...
            <div className="hero-stats animate d4">
              <div><div className="hero-stat-num">1000%</div><div className="hero-stat-label">Max Volume</div></div>
