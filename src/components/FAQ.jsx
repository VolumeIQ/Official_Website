...
const FAQ = () => {
  ...
  const faqs = [
    ...
    { q: "Does it work on Netflix / Spotify?", a: "VolumeIQ now supports DRM-protected sites like Netflix and Spotify. While advanced processing like boosting above 100% is limited by browser security on these sites, you still get full mixer control and normalization support." },
    { q: "How is this different from other volume boosters?", a: "Most boosters just amplify. VolumeIQ offers per-tab mixing, 1000% boost, normalization, Mono Audio, and a premium UI - all with zero data collection." },
